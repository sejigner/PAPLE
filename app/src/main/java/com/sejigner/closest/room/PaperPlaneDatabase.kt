...
@Database(entities = [FirstPaperPlanes::class, RepliedPaperPlanes::class, MyPaper::class, MyPaperPlaneRecord::class, ChatMessages::class, ChatRooms::class, Acquaintances::class, ChatRoomMessageCrossRef::class, User::class, FinishedChat::class], version = 1, exportSchema = false)
